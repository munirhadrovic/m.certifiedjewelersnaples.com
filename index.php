...
<html>
	...
	<body>
		...
		<div id="header-image" data-role="header" data-theme="<?php echo $theme ?>" data-position="fixed">
		    <h1 style="font-weight: bold"><img src="img/logo.png" alt="LOGO"></h1>
		</div>
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1>Powered by <a href="http://mobilegrows.com/" rel="external" >MobileGrows </a>|<a href="http://www.certifiedjewelersnaples.com/" rel="external"> Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
			  	...
			  	<div class="callbacks_container">
				    <ul class="rslides" id="slider4">
				      ...
				      <li>
				        <img src="img/slider-images/03.png" alt="">
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#service" data-transition="<?php echo $transitionefect ?>">ABOUT/HISTORY</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#webcams" data-transition="<?php echo $transitionefect ?>">DESIGNERS & COLLECTIONS</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">CUSTOM DESIGN</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">LATEST DESIGN</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#service" data-transition="<?php echo $transitionefect ?>">ESTATE JEWELRY</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#webcams" data-transition="<?php echo $transitionefect ?>">IN THE NEWS</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#service" data-transition="<?php echo $transitionefect ?>">ABOUT/HISTORY</a></li>
							<li><a href="#webcams" data-transition="<?php echo $transitionefect ?>">DESIGNERS & COLLECTIONS</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">CUSTOM DESIGN</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">LATEST DESIGN</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">ESTATE JEWELRY</a></li>
                            <li><a href="#webcams" data-transition="<?php echo $transitionefect ?>">IN THE NEWS</a></li>
                            <li><a href="#service" data-transition="<?php echo $transitionefect ?>">BLOG</a></li>
